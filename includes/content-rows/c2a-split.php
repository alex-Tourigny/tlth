...
if( get_sub_field('img-side') == 'right' ){
	...
	$class_1 = 'order-1 order-lg-0';
	$class_2 = 'order-0 order-lg-1';
}
?>
            ...
            <div class="col-12 col-lg-6 <?= $class_2; ?>">
                <div class="c2a-content">
					...
					<?php if( get_sub_field('subtitle') ) { ?>
                        <h4 data-aos="fade-up" data-aos-delay="50" style="color: <?=get_sub_field('subtitle-color'); ?>"><?= get_sub_field('subtitle'); ?></h4>
					<?php } ?>

                    <? if( get_sub_field('title') ){ ?>
                        <h2 data-aos="fade-up" data-aos-delay="100" style="color: <?=get_sub_field('title-color'); ?>"><?= get_sub_field('title'); ?></h2>
                    <? } ?>
