 ...
 * - A free shipping message via an ACF field.
 *
...
<div class="cart-pop-up">
    <div class="woocommerce-error">
        <p><?= pll__("Nous éprouvons présentement des difficulté avec l'affichage des produits dans le panier. Si vous ne voyez pas le produits que vous venez d'ajouter, rafraichissez la page ou passez à l'étape suivante pour voir la liste à jour de votre panier.") ?></p>
        <p><br></p>
        <div class="btn-container">
            <a onclick="location.reload()" class="btn red"><?= pll__("Rafraichir la page") ?></a>
            <a class="btn blue" href="/paiement"><?= pll__("Passer au paiement") ?></a>
        </div>
    </div>
</div>
        ...
        <tr>
            <td colspan="6" class="actions">
                ...
                <div class="add-extra-product">
                    <a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>" class="btn red"><?php echo pll__('ajouter-livre'); ?></a>
...
<div class="cart-collaterals">
    <?php if( get_field("shop-free-shipping-msg","option") ){ ?>
        <div class="woocommerce-info">
            <?php echo get_field("shop-free-shipping-msg", "option"); ?>
        </div>
    <?php } ?>
    <?php
    /**
